...
MEDIA_STRATEGY = {
    ...
    "target_video_pct": 80,            # governor target: ~80% video scenes
...
PUBLISH_WARMUP_MIN = 30            # Mínimo 30 min entre subida y publicación programada
...
YT_DEFAULT_TAGS = [
    ...
    "civilizaciones olvidadas",
    "julio cesar guerras galicas",
    "ariovisto batalla germanica",
    "baalbek megalitos misterio",
    "pueblos del mar civilizaciones",
    "blas de lezo batalla cartagena",
    # Tier 3: Ultra-long-tail (low competition)
    "como construyeron las piramides realmente",
    "civilizaciones que desaparecieron sin explicacion",
    "ruinas mas misteriosas del mundo",
    "descubrimientos arqueologicos que cambiaron la historia",
    "templos antiguos que aun existen",
    "ciudades perdidas encontradas recientemente",
    "misterios de la humanidad sin resolver",
    "enigmas historicos que la ciencia no explica",
    "secretos de civilizaciones antiguas documental",
    "culturas antiguas mas avanzadas",
    "imperios que desaparecieron misteriosamente",
    "lugares arqueologicos prohibidos",
    "mapas antiguos que no deberian existir",
    "tecnologia antigua imposible de explicar",
    "historia universal documental español",
...
SEO_SECONDARY_KEYWORDS = [
    ...
    # Mysteries (long-tail specific)
    "misterios de la humanidad sin resolver",
    "enigmas históricos inexplicables",
    "secretos de las pirámides",
    "civilizaciones desaparecidas sin rastro",
    "como construyeron baalbek los romanos",
    "guerras galicas julio cesar documental",
    "pueblos del mar quienes fueron realmente",
    "mapa de piri reis inexplicable",
    "piedra de la mujer embarazada baalbek",
    "tecnologia antigua imposible de explicar",
    "ciudades subterraneas antiguas descubiertas",
    "imperios mas misteriosos de la historia",
    # Format / channel
    "documental historia español",
...
MARATHON_NUM_SECTIONS = 12                   # "12 Civilizaciones que la Historia Enterró"
MARATHON_NARRATIVE_FORMAT = "historical_collapse"  # narración épica de colapso civilizatorio
