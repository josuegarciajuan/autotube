...
YT_DEFAULT_TAGS = [
    ...
    "enfermedades mas raras del mundo documental",
    "personas que no sienten dolor casos reales",
    "sindrome del cadaver ambulante explicacion",
    "gente que se convierte en piedra enfermedad",
    "que es el sindrome de capgras documental",
    "enfermedades que la medicina no puede curar",
    "trastornos psicologicos mas extraños del mundo",
    "mutaciones geneticas increibles en humanos",
    ...
    "priones enfermedad vacas locas en humanos",
    "sindrome del hombre arbol caso real",
    "niños que envejecen rapido progeria",
    "personas con superpoderes por enfermedades",
    # Tier 4: Format / audience intent
    "documental español medicina",
    "video ensayo medico",
    "historias medicas reales impactantes",
    "medicina y misterio documental",
    "ciencia medica explicada",
]
...
SEO_SECONDARY_KEYWORDS = [
    ...
    # Named conditions (specific)
    "sindrome de capgras",
    "sindrome del acento extranjero",
    "insensibilidad al dolor congenita",
    "fibrodisplasia osificante progresiva",
    "sindrome de cotard",
    "progeria envejecimiento prematuro",
    "sindrome del hombre arbol",
    "enfermedad de las vacas locas humanos",
    "mutacion genetica alas de mariposa",
    ...
    "personas que no pueden sentir dolor fisico",
    "sindrome del cadaver ambulante casos reales",
    "gente que se convierte literalmente en hueso",
    "que es realmente el sindrome de capgras",
    "enfermedades que los medicos no pueden explicar",
    "trastornos psicologicos mas raros del mundo",
    "mutaciones geneticas increibles documental",
    "casos medicos que desafiaron a la ciencia",
    "enfermedades raras que solo existen en un pais",
    "pacientes unicos en el mundo medicina",
    "priones enfermedad neurodegenerativa explicacion",
    # Format / channel
    "documental medico español",
    "video ensayo medicina",
    "historias medicas reales impactantes",
    "misterios del cuerpo humano documental",
    # Audience intent
...
MARATHON_NUM_SECTIONS = 12                   # "12 Anomalías Médicas que la Ciencia No Explica"
MARATHON_NARRATIVE_FORMAT = "top_cases"      # top casos médicos inexplicables
