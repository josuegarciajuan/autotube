...
Responde JSON: {{"bloques": [{{"texto": "..."}}]}}{source}{context}"""
    ...
    def _enrich_block_fields_batch(
        ...
        system_prompt = (
            ...
            "    alterna 'wide shot' ↔ 'medium shot' ↔ 'distant view'.\n"
            "  * Usa términos visuales concretos: 'aerial shot', 'wide angle', "
             "'medium shot', 'tracking shot', 'golden hour'. No uses close-up "
             "para personas.\n"
            "  * PERSONAS A DISTANCIA: si la escena incluye personas, encuádralas\n"
            "    en plano medio o general. NUNCA uses 'close-up', 'close up detail'\n"
            "    ni 'portrait' para personas — la gente debe verse a distancia,\n"
            "    nunca en primer plano del rostro.\n"
            ...
            "  * ANCLAJE DE ÉPOCA OBLIGATORIO: Si la narración es histórica o "
            "preindustrial, la query DEBE incluir un anclaje de época en inglés "
            "(ej: '17th century', 'medieval', 'ancient', '18th century') MÁS una "
            "señal material de la época (ej: 'wooden sailing ship', 'candlelit', "
            "'parchment', 'stone castle'). NUNCA dejes la query sin ancla temporal "
            "en escenas históricas.\n"
            "  * PROHÍBE ANACRONISMOS: Si la escena es histórica, NO uses términos "
            "modernos: NO uses 'city', 'canal', 'traffic', 'car', 'drone', 'building', "
            "'skyline', 'modern'. Para escenas marítimas históricas usa 'ocean', 'sea', "
            "'arctic', 'ice', 'wooden ship', 'sailing ship' en vez de 'river', 'canal', "
            "'city boats'.\n"
            "  * Traduce conceptos abstractos a puestas en escena observables: "
             "acciones, objetos y espacios. 'archive investigation' debe mostrar "
             "un archivista examinando documentos y pasando páginas; 'money' en "
             "Egipto antiguo debe mostrar trueque, bienes y pesas, nunca moneda "
             "moderna.\n"
            ...
            "  * BIEN (época anclada): '1611 Hudson Bay mutiny' → '17th century "
            "wooden sailing ship arctic ice crew'\n"
            ...
            "  * MAL (anacrónico): 'boat navigating city canal' para una escena "
