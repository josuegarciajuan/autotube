...
Responde JSON: {{"bloques": [{{"texto": "..."}}]}}{source}{context}"""
    ...
    def _enrich_block_fields_batch(
        ...
        system_prompt = (
            ...
            "  REGLAS OBLIGATORIAS:\n"
            "  * ANCLAJE TEMÁTICO: CADA query DEBE contener al menos 1-2 keywords "
            "extraídas del CONTENIDO NARRATIVO del bloque (personas históricas, "
            "lugares, eventos, objetos mencionados en la narración).\n"
            "  * FORMATO OBLIGATORIO: [keywords del TEMA histórico] + [keywords "
            "visuales/estilísticas]. AMBAS partes son necesarias.\n"
            ...
            "  * BIEN: 'french revolution guillotine dramatic lighting historical "
            "painting 16:9'\n"
            "  * BIEN: 'ancient Egyptian gold mask museum exhibit close up'\n"
            "  * MAL: 'Funeral Mask Egypt Art Institute Chicago' (nombre de museo)\n"
            "  * MAL: 'dramatic historical atmosphere 18th century' (sin keywords "
            "de tema concreto, solo términos genéricos)\n"
