...
6. CIERRE. El final debe incluir: \"{outro}\" como reflexion de cierre. Incluye una mencion natural a la proxima expedicion o historia que exploraras en el siguiente video (ej. \"en el proximo video\", \"en la siguiente entrega\"). PERO NO uses formulas genericas de YouTube como \"suscribete\", \"dale like\", \"activa la campanita\" ni similares.
